!(function (t) {
  ...
  function (t, r, n) {
    ...
    if ((!T || !E || E === A) && ((E = S.prototype), T))
      for (e in M) i[e] && p(i[e].prototype, E);
    ...
    j && p && h(y) !== A && p(y, A),
      (t.exports = {
        ...
        exportStatic: function (t, r, n) {
          ...
          if (o) {
            if (p) {
              if (n) for (e in M) (a = i[e]) && u(a, t) && delete a[t];
              if (S[t] && !n) return;
              try {
                return s(S, t, n ? r : (T && m[t]) || r);
              } catch (t) {}
            }
            for (e in M) !(a = i[e]) || (a[t] && !n) || s(a, t, r);
          }
        },
        isView: function (t) {
          var r = c(t);
          return "DataView" === r || u(M, r);
        },
        isTypedArray: P,
        TypedArray: S,
  ...
  function (t, r, n) {
    ...
    var e = n(0),
      ...
      Y = function (t, r) {
        return G(t, (r = g(r, !0))) ? s(2, t[r]) : M(t, r);
      },
      $ = function (t, r, n) {
      ...
      (w = function (t) {
        ...
        u(S.prototype, {
          ...
          getUint32: function (t) {
            return (
              P(D(this, 4, t, arguments.length > 1 ? arguments[1] : void 0)) >>>
              0
            );
          },
